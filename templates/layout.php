            ...
            <nav class="header__nav">
                ...
                <ul class="header__user-nav" style="margin-left: auto">
                    <li class="header__authorization">
                        <a class="header__user-button <?php if($current_page==='login.php') {echo 'header__user-button--active';} ?> header__authorization-button button" href="/login.php">Вход</a>
                    </li>
                    <li>
                        <a class="header__user-button <?php if($current_page==='register.php') {echo 'header__user-button--active';} ?> header__register-button button" href="/register.php">Регистрация</a>
                    </li>
                </ul>
                <?php else: ?>
