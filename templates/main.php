        ...
        <section class="authorization">
            ...
            <form class="authorization__form form" action="/main.php" method="post">
                <div class="authorization__input-wrapper form__input-wrapper">
                    <input class="authorization__input authorization__input--login form__input" type="text" name="username" placeholder="Логин">
                    ...
                    <?php if (isset($errors['username'])) : ?>
                        <span class="form__error-label"
                              style="position: static; font-size: 12px"><?= $errors['username'] ?></span>
                    <?php endif; ?>
                </div>
                <div class="authorization__input-wrapper form__input-wrapper">
